...
export default {
  ...
  methods: {
    ...
    calculeLaMaricaFormula(metros, valorMetro, subsidioPor, cargoFijo) {
    ...
    calculeEsaMierda(nombre, estratoStr, metros) {
      const estratoMap = {
      ...
      return {
        ...
        subsidioPor,
        estrato: estratoStr,
        total: this.calculeLaMaricaFormula(metros, valorMetro, subsidioPor, cargoFijo)
      }
    },
    ...
    agregarUsuario() {
      const filaCalculado = this.calculeEsaMierda(this.usuario, this.opcionEstrato, this.metros);
    ...
    editarFacturaAhorasi(){
      ...
      if (index < 0) return;    
      clonedUsuarios[index] = this.calculeEsaMierda(this.usuario, this.opcionEstrato, this.metros);
